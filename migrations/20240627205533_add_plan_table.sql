...
INSERT 
INTO plan (
  name, user_id, topic, topic_en, topic_short, goal, readiness_willingness, readiness_willingness_updated_by,
...
'ready 2',  'user', 'type_2',  'user', 'goal details 2',  'user', 'activity 2', 'user',
...
'ready 3',  'user', 'type_3',  'user', 'goal details 3',  'user', 'activity 3', 'user',
'plan note 3',  'user', 'contact 3',  'user', 'user'),
('PLAN4', 4, 'แผนควบคุมปัจจัยเสี่ยงทางสุขภาพ', 'Health Risk Control Plan', 'Health Risk', 'Goal 4',
'ready 4',  'user', 'type_4',  'user', 'goal details 4',  'user', 'activity 4', 'user',
...
'ready 5',  'user', 'type_5',  'user', 'goal details 5',  'user', 'activity 5', 'user',
'plan note 5',  'user', 'contact 5',  'user', 'user'),
('PLAN6', 6, 'แผนสุขภาวะชุมชน', 'Healthy Community Strengthening Plan', 'Community', 'Goal 6',
'ready 6',  'user', 'type_6',  'user', 'goal details 6',  'user', 'activity 6', 'user',
...
'ready 7',  'user', 'type_7',  'user', 'goal details 7',  'user', 'activity 7', 'user',
...
'ready 8',  'user', 'type_8',  'user', 'goal details 8',  'user', 'activity 8', 'user',
...
'ready 9',  'user', 'type_9',  'user', 'goal details 9',  'user', 'activity 9', 'user',
...
'ready 10',  'user', 'type_10',  'user', 'goal details 10',  'user', 'activity 10', 'user',
...
'ready 11',  'user', 'type_11',  'user', 'goal details 11',  'user', 'activity 11', 'user',
...
'ready 12',  'user', 'type_12',  'user', 'goal details 12',  'user', 'activity 12', 'user',
'plan note 12',  'user', 'contact 12',  'user', 'user'),
('PLAN14', 13, 'แผนอาหารเพื่อสุขภาวะ', 'Healthy Food Promotion Plan', 'Food Promotion', 'Goal 14',
'ready 14',  'user', 'type_14',  'user', 'goal details 14',  'user', 'activity 14',  'user',
...
'ready 15',  'user', 'type_15',  'user', 'goal details 15',  'user', 'activity 15',  'user',
